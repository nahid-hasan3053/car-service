    ...
    return (
        <div className='my-8'>
            <form onSubmit={handleOrder}>
                ...
                <h2 className="text-2xl mb-5 font-semibold">Price: ${price}</h2>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mb-3'>
                    ...
                    <input name='email' type="text" placeholder="Your Email" defaultValue={user?.email} className="input input-bordered input-info w-full" readOnly/>
                    <input name='phone' type="text" placeholder="Your Phone" className="input input-bordered input-info w-full" />
                </div>
